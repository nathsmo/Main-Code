...
class RLAgent(nn.Module):
    ...
    def __init__(self, args, prt, env, dataGen, reward_func, clAttentionActor, clAttentionCritic, is_train=True):
        ...
        # self.val_model_greedy = self.build_model("greedy")
    ...
    def build_model(self, decode_type= "greedy"): #, where=None):
        ...
        # print('----- Indices: ', idx) # Well this is very obviouly wrong.
    ...
    def evaluate_single(self, eval_type="greedy"):
        ...
        start_time = time.time()
        avg_reward = []
        # summary = self.val_model_greedy # self.val_model_greedy = self.build_model("greedy")
